...
$modules = [
    [
        ...
        'description' => InvoiceText::get('description'),
    ...
    [
        ...
        'eyebrow' => 'Operações de verificação',
        'title' => 'Gestão dos Espaços',
        'description' => 'Verificação dos espaços dos alojamentos e respetivas listas.',
        'href' => 'rooms.php',
        'status' => 'Disponível',
        'tone' => 'green',
    ],
