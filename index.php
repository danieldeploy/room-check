...
<head>
    ...
    <title>Portal de Operações — Welcome Hostel</title>
    <link rel="stylesheet" href="assets/portal.css">
</head>
<body>
    <main class="portal-shell">
        <nav class="portal-nav" aria-label="Sessão e administração">
            <a class="brand" href="index.php">Welcome Hostel</a>
            <div class="nav-actions">
                <?php if ($canManageUsers): ?><a href="admin/users.php">Utilizadores</a><?php endif; ?>
                <?php if ($canManagePermissions): ?><a href="admin/permissions.php">Permissões</a><?php endif; ?>
                <div class="user-chip">
                    <strong><?= htmlspecialchars((string) $currentUser['display_name'], ENT_QUOTES, 'UTF-8') ?></strong>
                    <span><?= htmlspecialchars(Auth::ROLES[(string) $currentUser['role']], ENT_QUOTES, 'UTF-8') ?></span>
                </div>
