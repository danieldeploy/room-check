...
<head>
    ...
    <link rel="stylesheet" href="assets/app.css?v=<?= (int) filemtime(__DIR__ . '/assets/app.css') ?>-item-layout-3">
    ...
    <script src="assets/app.js?v=<?= (int) filemtime(__DIR__ . '/assets/app.js') ?>-item-layout-3" defer></script>
</head>
<body>
