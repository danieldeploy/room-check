...
<head>
    ...
    <link rel="stylesheet" href="assets/app.css?v=<?= (int) filemtime(__DIR__ . '/assets/app.css') ?>-item-layout-2">
    ...
    <script src="assets/app.js?v=<?= (int) filemtime(__DIR__ . '/assets/app.js') ?>-item-layout-2" defer></script>
</head>
<body>
