...
assertValidationFeedback(str_contains($feedbackJs, 'Saved: translation correct or ambiguous'), 'English success feedback explains the algorithm conclusion');
assertValidationFeedback(str_contains($feedbackJs, 'Guardado: tradução correta ou ambígua'), 'Portuguese success feedback explains the algorithm conclusion');
