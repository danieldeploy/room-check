...
assertI18n(!str_contains((string) $lexicalSource, 'curl_init') && !str_contains((string) $lexicalSource, 'wiktionary'), 'lexical verification has no runtime network dependency');
