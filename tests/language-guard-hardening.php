...
assertHardening(str_contains($ptLexicon, "\ncasa\n") && str_contains($ptLexicon, "\nverificar\n"), 'Portuguese core vocabulary is bundled locally');
assertHardening(str_contains($technicalLexicon, 'wifi') && str_contains($technicalLexicon, 'hvac'), 'wifi and HVAC are neutral technical terms regardless of case');
