...
este repositório pela UAPI, com verificações de branch/commit e acompanhamento da
tarefa. A configuração de tokens e a ligação real ainda precisam de ser validadas.
