...
final class SiteTranslations
{
    ...
    public static function catalog(): array
    {
        $catalog = [
            ...
            'Gestão dos espaços' => 'Space management',
            'GESTÃO DOS ESPAÇOS' => 'SPACE MANAGEMENT',
            'Gerir categorias de listas' => 'Manage list categories',

            // Verification categories.
            'Categorias de listas' => 'List categories',
            'Categorias da gestão dos espaços' => 'Space management categories',
            'Listas de itens' => 'Item lists',
            'Categorias' => 'Categories',
            'Categoria criada e adicionada ao menu.' => 'Category created and added to the menu.',
            'Nome da categoria atualizado.' => 'Category name updated.',
            'Categoria apagada com {lists} e {items}.' => 'Category deleted with {lists} and {items}.',
            'O nome da categoria deve ter entre 1 e 80 caracteres.' => 'The category name must contain between 1 and 80 characters.',
            'Categoria não encontrada.' => 'Category not found.',
            'Não foi possível criar a categoria.' => 'Could not create the category.',
            'Não foi possível guardar a categoria.' => 'Could not save the category.',
            'Já existe uma categoria com esse nome.' => 'A category with that name already exists.',
            'A tabela de categorias ainda não existe. Importe a migração 022_verification_categories.sql.' => 'The categories table does not exist yet. Import migration 022_verification_categories.sql.',
            'Importe migrations/022_verification_categories.sql para ativar a gestão de categorias.' => 'Import migrations/022_verification_categories.sql to enable category management.',
            'Esta categoria não pode ser apagada porque já existem itens atribuídos a colaboradores.' => 'This category cannot be deleted because items have already been assigned to staff.',
            'A categoria “{name}” não pode ser apagada porque já existem itens atribuídos a colaboradores.' => 'The “{name}” category cannot be deleted because items have already been assigned to staff.',
            'A categoria “{name}” contém {lists} e {items}. Todo esse conteúdo será apagado. Quer continuar?' => 'The “{name}” category contains {lists} and {items}. All of this content will be deleted. Do you want to continue?',
            'Quer apagar a categoria “{name}”?' => 'Do you want to delete the “{name}” category?',
