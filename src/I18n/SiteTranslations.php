...
final class SiteTranslations
{
    ...
    public static function catalog(): array
    {
        $catalog = [
            ...
            'O texto não foi guardado ou traduzido. Quer tentar novamente ou anular a edição?' => 'The text was not saved or translated. Do you want to try again or cancel the edit?',
            ...
            'Alteração guardada para tradução.' => 'Edit queued for translation.',
            'Intervalo guardado para tradução.' => 'Interval queued for translation.',
            'O intervalo foi alterado por outro utilizador. Recarregue e tente novamente.' => 'The period was changed by another user. Reload and try again.',
            'A lista foi alterada por outro utilizador. Recarregue e tente novamente.' => 'The list was changed by another user. Reload and try again.',
            'Lista não encontrada.' => 'List not found.',
            'A área foi alterada por outro utilizador. Recarregue e tente novamente.' => 'The area was changed by another user. Reload and try again.',
            ...
            'Selecionar área para editar' => 'Select area to edit',
            'Selecionar área para apagar' => 'Select area to delete',
            'Escolher área' => 'Choose area',
            'Editar área selecionada' => 'Edit selected area',
            'Apagar área selecionada' => 'Delete selected area',
            'Guardar área' => 'Save area',
            'Apagar área' => 'Delete area',
            'Área:' => 'Area:',
